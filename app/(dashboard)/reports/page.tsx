        ...
        <TabsContent value="sales" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed sales analytics and performance metrics</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="inventory" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Stock levels, turnover rates, and inventory analytics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px] flex items-center justify-center border rounded-md">
                <div className="text-center">
                  <Package className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                  <p className="text-muted-foreground">Inventory reports will be displayed here</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="financial" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Profit & loss, cash flow, and financial performance</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px] flex items-center justify-center border rounded-md">
                <div className="text-center">
